...
val_gen = generator(float_data,
                    lookback=lookback,
                    delay=delay,
                    min_index=101, #200001
                    max_index=150, #300000
                    step=step,
                    batch_size=batch_size)
test_gen = generator(float_data,
                     lookback=lookback,
                     delay=delay,
                     min_index=151, #300001
                     max_index=None,
                     step=step,
                     batch_size=batch_size)

val_steps = (150 - 101 - lookback)
test_steps = (len(float_data) - 151 - lookback)
